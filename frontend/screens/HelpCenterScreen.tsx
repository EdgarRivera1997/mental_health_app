...
export default function HelpCenterScreen(){
    ...
    const [people,setPeople] = useState([
        //{name: 'Hospital San Juan Capestran', id: '1',phone:' (787) 852-0505',web:''},
        //{name : 'Beachway Therapy Center', id:'2',phone:'(877) 226-5235',web:'https://www.beachway.com/?utm_source=psychology_today'},
        //{name : 'Hogar Crea Coamo Varones', id:'3',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Cayey', id:'4',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea San Sebastian', id: '5',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Las Marias', id: '6',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea San Humacao', id: '7',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Gurabo', id: '8',phone:'888-991-1168',web:''},
       // {name: 'Hogar Crea Corozal', id: '9',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea La Quinta', id: '10',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Comerio', id: '11',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Naranjito', id: '12',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Manati Varones', id: '13',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Coamo Damas', id: '14',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Yabucoa', id: '15',phone:'888-991-1168',web:''},
       // {name: 'Hogar Crea Sabana Catano', id: '16',phone:'888-991-1168',web:''},
        //{name: 'Hogar Crea Guaynabo Adultos', id: '17',phone:'888-991-1168',web:''},
        //{name: 'Casa Luz y Vida Incorporated', id: '18',phone:'888-991-1168',web:''},
        //{name: 'Silo Mision Christiana Incorporated', id: '19',phone:'888-991-1168',web:''},
       // {name: 'Hogar Jesus Incorporated', id: '20',phone:'888-991-1168',web:''},
        //{name: 'Hogar Nuevo Pacto', id: '21',phone:'888-991-1168',web:''},
